...
public class Ghost : MonoBehaviour {
	...
	public void StartRecording() {
		Debug.Log("Load File Location: " + Application.persistentDataPath + "/Ghost");
	...
	public void loadFromFile()
	{
		...
		if (File.Exists(Application.persistentDataPath + "/GhostLvl1_1"))  //Old: Ghost
		{
			Debug.Log("Load File Location: " + Application.persistentDataPath + "/GhostLvl1_1");
			BinaryFormatter bf = new BinaryFormatter();
			FileStream file = File.Open(Application.persistentDataPath + "/GhostLvl1_1", FileMode.Open);
	...
	public void SaveGhostToFile()
	{
		...
		Debug.Log("Saved File Location: " + Application.persistentDataPath + "/Ghost");
		// Write data to disk
